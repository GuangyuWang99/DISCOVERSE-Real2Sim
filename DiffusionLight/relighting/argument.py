...
SD_MODELS = {
    ...
    # ----------------------------------------------------------
    # "sdxl": "/YourCKPTPath/stable-diffusion-xl-base-1.0",
    # ----------------------------------------------------------
...
VAE_MODELS = {
    ...
    # ----------------------------------------------------------
    # "sdxl": "/YourCKPTPath/sdxl-vae-fp16-fix",
    # ----------------------------------------------------------
...
CONTROLNET_MODELS = {
    ...
    # ----------------------------------------------------------
    # "sdxl": "/YourCKPTPath/controlnet-depth-sdxl-1.0",
    # ----------------------------------------------------------
...
# ----------------------------------------------------------
# DEPTH_ESTIMATOR = "/YourCKPTPath/dpt-hybrid-midas"
# ----------------------------------------------------------